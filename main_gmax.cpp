...
int main (int argc, char *argv[]) {
	...
	modisflag = atoi (*++argv) ;
	strcpy (daystr, *++argv) ;
	strcpy (webdir,"/hotspot3/data2/maxalerts/2014/") ;
	strcpy (webexc,"/hotspot3/data2/alerts_exclusive/2014/") ;
	...
	fprintf (flog, "FName\tJDay\tUnixtime\t#NTI\tDEL12\tDEL15\tDEL20\r\n") ;
	...
	*/
    ...
    int num_max_hits = al->calc_max (12., b21, b22, b32, max2232, al_max, al_max_inds, al_max_vals) ;
	...
	for (i=0; i<al_max_inds.size() ; i++) {
		...
		tdiff = al_max[index] ;
		if (al_max_vals.at(i) < .999 || tdiff < 12) continue ;
