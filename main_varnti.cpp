...
int main (int argc, char *argv[]) {
	...
	*/
	...
	int num_std_hits = al->calc_varnti (b21, b22, b32, al_bb, mnstdv, mnstdv_32, al_bb_inds, al_bb_vals) ;
	...
	for (i=0; i<al_bb_inds.size() ; i++) {
		...
		float ntival = al_bb_vals.at(i) ;
		// get background temp
		exceedvalue = al_bb[index] ;
